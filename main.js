...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function startStreaming() {
        ...
        const params = new URLSearchParams({ scale: elements.scale.value, is_color: 'true', speed: elements.speed.value });
    ...
    downloadBtn.onclick = async () => {
        ...
        const params = new URLSearchParams({ scale: elements.scale.value, is_color: 'true', audio_mode: elements.audio.value });
        try {
        ...
        } catch (e) { updateStatus('通信エラー', '⚠'); }
        finally { downloadBtn.disabled = false; downloadBtn.querySelector('.btn-text').textContent = "PROCESS & DOWNLOAD"; }
    };
